...
describe("concat", () => {
  it("should combine erick and ogaro", () => {
    const result = concat("erick", "ogaro");
    expect(result).to.equal("erickogaro");
  });

  it("should combine Type and Script", () => {
    const result = concat("Type", "Script");
